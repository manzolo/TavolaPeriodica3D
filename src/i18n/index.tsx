...
const STRINGS: Dict = {
  ...
  navTitle: { it: 'Navigazione', en: 'Navigation' },
  navToggle: { it: 'Navigazione', en: 'Navigation' },
  navUp: { it: 'Su', en: 'Up' },
  navDown: { it: 'Giù', en: 'Down' },
  navLeft: { it: 'Sinistra', en: 'Left' },
  navRight: { it: 'Destra', en: 'Right' },
  navZoomIn: { it: 'Ingrandisci', en: 'Zoom in' },
  navZoomOut: { it: 'Rimpicciolisci', en: 'Zoom out' },
  navToggleMode: {
    it: 'Cambia modalità: rotazione (3D) / spostamento (2D)',
    en: 'Toggle mode: rotate (3D) / move (2D)',
  },
  navMode3D: { it: 'Modalità rotazione (3D)', en: 'Rotate mode (3D)' },
  navMode2D: { it: 'Modalità spostamento (2D)', en: 'Move mode (2D)' },
